...
const SignUp = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-4xl font-bold mb-6 text-center text-indigo-600">Sign Up</h2>
        ...
        <p className="text-center text-gray-600 mt-4">Already have an account? <Link href="/login" className="text-indigo-600">Login</Link></p>
      </motion.div>
    </motion.div>
  );
};
